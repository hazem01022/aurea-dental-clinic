...
const StickyWhatsApp = () => (
  <a
    ...
    className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[hsl(142,70%,38%)] hover:bg-[hsl(142,70%,32%)] shadow-elegant flex items-center justify-center hover:scale-110 transition-all duration-300"
  >
